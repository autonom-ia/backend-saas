// Shared CORS utilities for API Gateway Lambda handlers
// Allows localhost for dev and any subdomain of autonomia.site in prod.
// Usage: const { createResponse, preflight, getOrigin } = require('./cors');
...
function buildCorsHeaders(origin) {
  ...
  // Disallow by not echoing origin. Some clients respect explicit 'null'.
