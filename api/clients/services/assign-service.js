...
// Configuração da conexão com o banco de dados do Chatwoot
async function createChatwootDbConnection(prefix) {
  try {
    ...
    // Criar conexão com o banco de dados do Chatwoot usando os parâmetros obtidos
    console.log(`Criando conexão para ${host}:${port}/${name}`);
