exports.up = function(knex) {
  return knex.schema
    .createTable('account_integration_api_field', (table) => {
      table.uuid('account_integration_api_field_id').primary().defaultTo(knex.raw('gen_random_uuid()'));
      ...
      table.unique(['account_integration_api_id', 'api_field_key'], 'account_integration_api_field_api_key_uk');
      table.check("data_type IN ('string', 'number', 'date', 'boolean', 'enum', 'object')");
    });
};
